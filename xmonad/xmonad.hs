...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch dmenu
    , ((modm,               xK_p     ), spawn "rofi -combi-modi window,drun,ssh -show combi -icon-theme 'Papirus' -show-icons -dpi 192")
    ...
    -- Screenshot controls
    , ((0, xK_Print), spawn "flameshot full -c -p /home/itziar/Pictures/Screenshots/")
    , ((modm, xK_Print), spawn "flameshot gui -p /home/itziar/Pictures/Screenshots/")
    ...
    -- Brightness Commands
    , ((0, xF86XK_MonBrightnessUp)    , spawn "~/Scripts/Dunst/brightness.sh -i 5 -pyn")
    , ((0, xF86XK_MonBrightnessDown)  , spawn "~/Scripts/Dunst/brightness.sh -d 5 -pyn")

      -- Volume Notifications
    , ((0, xF86XK_AudioLowerVolume)   , spawn "~/Scripts/Dunst/volume.sh -d 5 -pnyl")
    , ((0, xF86XK_AudioMute)          , spawn "~/Scripts/Dunst/volume.sh -nyml")
    , ((0, xF86XK_AudioRaiseVolume)   , spawn "~/Scripts/Dunst/volume.sh -i 5 -pnyl")
    ]
    ++
...
myLayouts = renamed [CutWordsLeft 1] .
  ...
  where
    ...
    defTabbed = def
        ...
        , fontName = "VictorMono Nerd Font:size=10" }
...
myStartupHook = do
    ...
    spawnOnce "megasync"
    spawnOnce "flameshot"
    spawn "~/.config/polybar/polybar-12/launch.sh"
