...
augroup packer_load_aucmds
  ...
  au FileType pandoc ++once call s:load(['ale', 'markdown-preview.nvim', 'vim-pandoc'], { "ft": "pandoc" })
  ...
  au FileType markdown ++once call s:load(['ale', 'markdown-preview.nvim', 'vim-pandoc'], { "ft": "markdown" })
